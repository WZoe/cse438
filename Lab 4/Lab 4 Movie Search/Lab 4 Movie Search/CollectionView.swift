...
//        collectionView.allowsSelection = true
        ...
        actionView.register(CollectionsCell.self, forCellWithReuseIdentifier: "actionCell")
        comedyView.register(CollectionsCell.self, forCellWithReuseIdentifier: "comedyCell")
        romanceView.register(CollectionsCell.self, forCellWithReuseIdentifier: "romanceCell")
        mysteryView.register(CollectionsCell.self, forCellWithReuseIdentifier: "mysteryCell")
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 1:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "actionCell", for: indexPath) as! CollectionsCell
        ...
        case 2:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "comedyCell", for: indexPath) as! CollectionsCell
            ...
            return cell as UICollectionViewCell
        case 3:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "mysteryCell", for: indexPath) as! CollectionsCell
            ...
            return cell as UICollectionViewCell
        default:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "romanceCell", for: indexPath) as! CollectionsCell
